...
{
{text = 'قناة السورس', url='https://t.me/T3TTT'},
},
}
}
...
{
{text = '𝑺𝒐𝒖𝒓𝒄𝒆', url='https://t.me/T3TTT'},
},
}
}
LuaTele.sendText(msg_chat_id,msg_id,[[
...
{
{text = 'قناة السورس',url="t.me/T3TTT"}
},
}
...
{
{text = '❲ 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓🎖 ❳', url = "https://t.me/T3TTT"}
},
{
{text = '❲ 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓🎖 ❳', url = "https://t.me/N_P_8"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,"[Source Black](t.me/T3TTT)\n\n[سورس بلاك](t.me/T3TTT)","md",true, false, false, false,reply_markup)
end
...
{
{text = 'تحديثات كاي', url = 't.me/T3TTT'}, 
},
}
}
